...
# RUN apt-get install -y --no-install-recommends libjpeg-turbo8-dev=1.4.2-0ubuntu3 libxslt-dev
RUN apt-get install -y --no-install-recommends libhdf5-dev libmunge-dev libxml2-dev libopenblas-dev liblapack-dev
...
RUN pip3 install pygraphml matplotlib scipy pandas numpy \
